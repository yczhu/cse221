...
all: rdtsc2.c pcall0.c pcall1.c pcall2.c pcall3.c pcall4.c pcall5.c pcall6.c pcall7.c context_switch.c loop.c syscall.c pthread_context_switch.c pcreate.c tcreate.c seq-read-block.c
...
clean:
	$(RM) rdtsc proc0 proc1 proc2 proc3 proc4 proc5 proc6 proc7 loop context_switch pcreate tcreate syscall pthread_context_switch mem_latency page_fault seq-read-block
